#!/usr/bin/env -S node
import type { Contract as End } from '../../snapshots/09126a9123f9c4131cf198ce60b8bf4f37c0dcb4b45c11c50c2b520d6f4bb95d/contract';
import endContract from '../../snapshots/09126a9123f9c4131cf198ce60b8bf4f37c0dcb4b45c11c50c2b520d6f4bb95d/contract.json' with { type: 'json' };
    ...
    return [
      ...
      this.createTable({
        ...
        columns: [
          ...
          col('encryptedKey', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('isActive', 'bool', {
            notNull: true,
            default: lit(true),
          ...
          col('keyName', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('provider', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
      ...
      this.createTable({
        ...
        columns: [
          col('defaultModel', 'text', { codecRef: { codecId: 'pg/text@1' } }),
          col('defaultProvider', 'text', {
            notNull: true,
            default: lit('openrouter'),
            codecRef: { codecId: 'pg/text@1' },
          }),
          col('id', 'text', { notNull: true, codecRef: { codecId: 'pg/text@1' } }),
          col('streamResponse', 'bool', {
            notNull: true,
            default: lit(true),
            codecRef: { codecId: 'pg/bool@1' },
          }),
      ...
      this.addUnique({
        schema: 'public',
        table: 'userPreferences',
        constraint: 'userPreferences_userId_key',
        columns: ['userId'],
      }),
      this.createIndex({
        schema: 'public',
      ...
      this.createIndex({
        schema: 'public',
        table: 'apiKey',
        index: 'apiKey_provider_idx_faf3af28',
        columns: ['provider'],
      }),
      this.createIndex({
        schema: 'public',
        table: 'apiKey',
        index: 'apiKey_userId_idx_a489d58a',
        columns: ['userId'],
      }),
      this.createIndex({
        schema: 'public',
